...
export function LeftRail({ activeSection }: LeftRailProps) {
  ...
  return (
    ...
    >
      ...
      {/* Section Indicator */}
      <div className="mb-12">
        <p className="text-xs text-muted-foreground mb-4 uppercase tracking-wider">Navigation</p>
      ...
      {/* Top Tech */}
      <div>
        <p className="text-xs text-muted-foreground mb-4 uppercase tracking-wider">Focus Stack</p>
