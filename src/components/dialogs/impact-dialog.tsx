        ...
        <AnimatedDialogWrapper>
          <div className="grid md:grid-cols-2 gap-6">
            {IMPACT_METRICS.map((metric, index) => {
              const style = metricStyles[metric.id as keyof typeof metricStyles];
              ...
              return (
                <motion.div
                  ...
                  className={`bg-gradient-to-br ${style.color} border rounded-2xl p-6 space-y-4 cursor-default shadow-lg hover:shadow-xl transition-shadow`}
                >
          ...
          <AnimatedSection delay={0.5}>
            <div className="bg-muted/50 backdrop-blur-sm rounded-xl p-6 border border-primary/10">
              ...
              <ul className="space-y-3">
                {IMPACT_ACHIEVEMENTS.map((achievement, index) => (
                  <motion.li
                    key={index}
